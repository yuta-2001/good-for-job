																			...
																			@foreach ($entries as $entry)
																				<tr class="border-b even:bg-gray-50">
																					...
																					<td class="w-60 flex items-center p-4 pl-0">
																						...
																						@else
																							<a href="{{ route('chat.show', ['entry' => $entry->id]) }}" class="text-white bg-green-500 border-0 py-2 px-3 focus:outline-none hover:bg-green-600 rounded text-lg mr-2">チャット</a>
																						@endif
