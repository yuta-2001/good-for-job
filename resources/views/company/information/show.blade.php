<x-app-layout>
	<x-slot name="header">
			<h2 class="font-semibold text-xl text-gray-800 leading-tight">
					{{ $company->name }}<span class="text-md ml-2">企業情報</span>
			</h2>
	</x-slot>
					...
					<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
						<section class="text-gray-600 body-font overflow-hidden">
							...
							<div class="container px-20 py-24 mx-auto">
								...
								<button type="button" onclick="location.href='{{ route('company.information.edit', ['information' => Auth::id()]) }}'" class="flex mx-auto text-white bg-green-400 border-0 py-2 px-8 focus:outline-none hover:bg-green-500 rounded text-lg mb-3">編集する</button>
							</div>
						</section>
					</div>
			</div>
